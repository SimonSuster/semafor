...
SEMAFOR_HOME=/home/p262594/Apps/semafor
CLASSPATH=".:${SEMAFOR_HOME}/target/Semafor-3.0-alpha-04.jar"
#CLASSPATH=".:${SEMAFOR_HOME}/out/artifacts/Semafor_jar/Semafor.jar"
...
MALT_MODEL_DIR="${SEMAFOR_HOME}/semafor_malt_model_20121129"
...
#MALT_MODEL_DIR="${SEMAFOR_HOME}/training/data/retrain_simple"
